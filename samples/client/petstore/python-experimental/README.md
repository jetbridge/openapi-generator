...
## Documentation For Models
 ...
 - [AdditionalPropertiesAnyType](docs/.md)
 - [AdditionalPropertiesArray](docs/.md)
 - [AdditionalPropertiesBoolean](docs/.md)
 - [AdditionalPropertiesClass](docs/.md)
 - [AdditionalPropertiesInteger](docs/.md)
 - [AdditionalPropertiesNumber](docs/.md)
 - [AdditionalPropertiesObject](docs/.md)
 - [AdditionalPropertiesString](docs/.md)
 - [Animal](docs/.md)
 - [AnimalFarm](docs/.md)
 - [ApiResponse](docs/.md)
 ...
 - [ChildDog](docs/.md)
 - [ChildDogAllOf](docs/.md)
 - [ChildLizard](docs/.md)
 - [ChildLizardAllOf](docs/.md)
 ...
 - [Tag](docs/.md)
 - [TypeHolderDefault](docs/a model to test optional properties with server defaults.md)
 - [TypeHolderExample](docs/a model to test required properties with an example and length one enum.md)
 - [User](docs/.md)
 - [XmlItem](docs/.md)
